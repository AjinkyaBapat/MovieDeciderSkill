    ...
    'Watch_or_not': function () {
        ...
        httpGet(Movie,  (myResult1, myResult2, myResult3, myResult4, imdb, rottentomatoes, metacritic) => {
                ...
                if (myResult2 == "False") {
                    ...
                    this.response.speak('The movie: ' + myResult1 + ' has got mixed responses from its viewers.  You can watch it if you want or I can suggest you a different movie of the same genre. May I?' );
                    this.emit(':responseReady');
